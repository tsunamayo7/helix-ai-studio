...
v11.0.0 Phase 1-C: MCP管理・カスタムサーバー削除、記憶セクション簡略化
  - MCP管理はCloudAI設定/Ollama設定タブに移設（Phase 2/5）
  - カスタムサーバー設定はCloudAI設定/Ollama設定タブに移設
...
class SettingsCortexTab(QWidget):
    ...
    # v11.0.0: カスタムサーバー管理はCloudAI設定/Ollama設定タブに移設
    ...
    def _on_save_settings(self):
        ...
        try:
            ...
            settings_data = {
                ...
                # v11.0.0: MCP設定はCloudAI設定/Ollama設定タブに移設
