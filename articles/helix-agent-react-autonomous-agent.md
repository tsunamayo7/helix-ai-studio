...
本記事は v0.4.0 / 144 テスト / 7 ツールの初期 ReAct 実装の解説ですが、現在は **v0.15.1 / 347 テスト / 27 MCPツール** まで拡張されています:

- **agent_task / think / parallel_tasks** など 27 ツールに整理
- **4 層コードレビューパイプライン** (gemma4 → Sonnet → Opus → Codex)
- **部門別 RAG** (`dept_search` / `dept_store`、5 部門 1,419 points)
...
執筆時 144 テスト通過、MIT ライセンスです (現在は v0.15.1 / **347 テスト**)。
