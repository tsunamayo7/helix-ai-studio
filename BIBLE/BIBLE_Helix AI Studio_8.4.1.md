...
│   └── BIBLE_Helix AI Studio_8.4.1.md   # ★ 本ファイル
├── config/                       # 設定ファイル
│   ├── app_settings.json         # ★ v8.4.1: version="8.4.1", claude.default_model="claude-opus-4-6"
...
│   │   ├── bible_schema.py       # スキーマ定義 ★ v8.4.1: _NUM_パターン追加
...
│   ├── utils/
│   │   ├── constants.py          # 定数定義 ★ v8.4.1: APP_VERSION="8.4.1", MID_SESSION定数追加
